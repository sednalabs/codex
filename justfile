...
core-subagent-model-pinning-targeted:
    ...
    cargo nextest run -p codex-state -p codex-thread-store --no-fail-fast --no-tests=fail --lib -- migrations::tests::inference_identity_authority_migration_upgrades_0044_schema model::thread_metadata::tests::inference_identity_authority_distinguishes_presence_and_malformed_data runtime::threads::tests::upsert_thread_preserves_existing_git_fields_atomically in_memory::tests::inference_identity_patches_mutate_only_the_present_field_in_memory local::update_thread_metadata::tests::update_thread_metadata_applies_combined_explicit_patch types::tests::thread_metadata_patch_round_trips_optional_clears --exact
