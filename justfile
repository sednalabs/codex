...
core-subagent-model-pinning-targeted:
    ...
    CODEX_JS_REPL_NODE_PATH="${CODEX_JS_REPL_NODE_PATH:-/tmp/codex-node22/bin/node}" cargo test -p codex-core --test all suite::subagent_runtime_identity:: -- --test-threads=1
