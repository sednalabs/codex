...
core-carry-core-smoke:
    ...
    CODEX_JS_REPL_NODE_PATH="${CODEX_JS_REPL_NODE_PATH:-/tmp/codex-node22/bin/node}" cargo nextest run -j 1 -p codex-core --lib -- multi_agent_v2_wait_agent_honors_return_when_all --exact
