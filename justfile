...
core-subagent-model-pinning-targeted:
    ...
    cargo nextest run -p codex-protocol --no-fail-fast --no-tests=fail --lib -- inference_identity_tests::thread_inference_identity_constructor_and_direct_serde_validate_without_normalizing --exact
