...
session-tui-resource-stability-targeted: core-multi-agent-orchestration-targeted
    ...
    cargo test -p codex-app-server-client --lib tests::in_process_pending_required_event_still_allows_request_control -- --exact --test-threads=1
    cargo test -p codex-app-server-client --lib tests::in_process_pending_required_event_still_allows_resolve_control -- --exact --test-threads=1
    cargo test -p codex-app-server-client --lib tests::in_process_pending_required_event_still_allows_reject_control -- --exact --test-threads=1
