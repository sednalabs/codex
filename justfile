...
core-carry-smoke:
    ...
    cargo test -p codex-tui-app-server codex_tui_app_server::app::tests::replayed_turn_complete_submits_restored_queued_follow_up -- --exact --test-threads=1
    cargo test -p codex-tui-app-server codex_tui_app_server::app::tests::replayed_turn_complete_opens_restored_queued_approvals_command -- --exact --test-threads=1
    cargo test -p codex-tui-app-server codex_tui_app_server::app::tests::replayed_turn_complete_keeps_message_after_restored_queued_command_runs_first -- --exact --test-threads=1
    cargo test -p codex-tui-app-server codex_tui_app_server::app::tests::sync_active_agent_label_updates_footer_for_selected_thread -- --exact --test-threads=1
...
core-ledger-smoke:
    cargo test -p codex-state codex_state::runtime::tests::init_removes_legacy_logs_and_usage_db_files -- --exact --test-threads=1
    cargo test -p codex-state codex_state::runtime::usage::tests::usage_logger_records_requested_model_and_quota_snapshot -- --exact --test-threads=1
    cargo test -p codex-state codex_state::runtime::usage::tests::usage_logger_tracks_tool_call_lifecycle -- --exact --test-threads=1
    cargo test -p codex-state codex_state::runtime::usage::tests::usage_logger_captures_spawn_request_and_fork_snapshot -- --exact --test-threads=1
    cargo test -p codex-state codex_state::runtime::usage::tests::usage_logger_resolves_root_thread_from_parent_or_fork -- --exact --test-threads=1
    cargo test -p codex-state codex_state::runtime::usage::tests::usage_logger_clears_turn_snapshot_after_turn_complete -- --exact --test-threads=1
    cargo test -p codex-state codex_state::runtime::usage::tests::usage_logger_resolves_root_thread_from_persisted_lineage_after_restart -- --exact --test-threads=1
