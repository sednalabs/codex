...
core-multi-agent-orchestration-targeted:
    RUST_MIN_STACK="${RUST_MIN_STACK:-{{ rust_min_stack }}}" CODEX_JS_REPL_NODE_PATH="${CODEX_JS_REPL_NODE_PATH:-/tmp/codex-node22/bin/node}" cargo nextest run -p codex-core --no-fail-fast --no-tests=fail --lib -- tools::handlers::multi_agents::tests::multi_agent_v2_list_agents_returns_completed_status tools::handlers::multi_agents_v2::wait::tests::completion_rule_distinguishes_any_from_all agent::control::residency::tests::terminal_idle_unload_preserves_fifo_mail_and_reloads_cold_agent agent::control::residency::tests::explicit_v2_resume_waits_for_terminal_idle_reload_gate agent::control::residency::tests::terminal_idle_unload_timeout_zero_disables_unload agent::control::residency::tests::terminal_idle_unload_is_invalidated_by_new_user_work agent::control::residency::tests::terminal_idle_unload_failure_preserves_trigger_mail_and_residency agent::control::residency::tests::terminal_idle_unload_waits_for_terminal_finalization agent::control::residency::tests::terminal_idle_unload_waits_for_accepted_submission_acknowledgement agent::control::residency::tests::explicit_v2_resume_reserves_the_only_child_residency_slot agent::control::residency::tests::residency_slot_reservation_unloads_oldest_idle_v2_agent agent::control::residency::tests::interrupted_v2_agent_remains_known_and_reloads_after_residency_eviction agent::control::residency::tests::ephemeral_v2_agent_is_not_evicted_without_reloadable_history agent::registry::tests::cold_status_text_stays_compact_when_json_escaped agent::control::tests::ensure_v2_agent_loaded_reloads_registered_unloaded_agent context::world_state::multi_agent_mode::tests::custom_mode_removal_replaces_retained_instructions context::world_state::multi_agent_mode::tests::snapshots --exact
...
session-tui-resource-stability-targeted: core-multi-agent-orchestration-targeted
    ...
    RUST_MIN_STACK="${RUST_MIN_STACK:-{{ rust_min_stack }}}" cargo test -p codex-app-server-client --lib tests::in_process_pending_required_event_still_allows_request_control -- --exact --test-threads=1
    RUST_MIN_STACK="${RUST_MIN_STACK:-{{ rust_min_stack }}}" cargo test -p codex-app-server-client --lib tests::in_process_pending_required_event_still_allows_resolve_control -- --exact --test-threads=1
    RUST_MIN_STACK="${RUST_MIN_STACK:-{{ rust_min_stack }}}" cargo test -p codex-app-server-client --lib tests::in_process_pending_required_event_still_allows_reject_control -- --exact --test-threads=1
    RUST_MIN_STACK="${RUST_MIN_STACK:-{{ rust_min_stack }}}" cargo test -p codex-app-server-client --lib shutdown_releases_a_pending_required_facade_event -- --test-threads=1
