...
p3-terminal-consumer-probe:
    RUST_MIN_STACK={{ rust_min_stack }} CODEX_JS_REPL_NODE_PATH="${CODEX_JS_REPL_NODE_PATH:-/tmp/codex-node22/bin/node}" cargo nextest run -p codex-core --no-fail-fast --lib -- --exact config::schema::tests::config_schema_matches_fixture agent::control_tests::spawn_agent_creates_thread_and_sends_prompt agent::control_tests::send_inter_agent_communication_without_turn_queues_message_without_triggering_turn tools::handlers::multi_agents_tests::multi_agent_v2_spawn_returns_path_and_send_message_accepts_relative_path tools::handlers::multi_agents_tests::multi_agent_v2_wait_agent_returns_summary_for_mailbox_activity tools::handlers::multi_agents_tests::multi_agent_v2_interrupt_agent_accepts_task_name_target tools::handlers::multi_agents_tests::multi_agent_v2_followup_task_completion_notifies_parent_on_every_turn
    RUST_MIN_STACK={{ rust_min_stack }} CODEX_JS_REPL_NODE_PATH="${CODEX_JS_REPL_NODE_PATH:-/tmp/codex-node22/bin/node}" cargo nextest run -p codex-core --no-fail-fast --test all -- --exact suite::pending_input::steer_interrupts_wait_agent_and_is_sent_in_follow_up_request suite::subagent_notifications::multi_agent_v2_spawn_sends_agent_message_to_child suite::subagent_notifications::plaintext_multi_agent_v2_completion_sends_agent_message

# Host lane compatibility: the main workflow catalog invokes this recipe name.
core-subagent-surface-targeted: p3-terminal-consumer-probe
