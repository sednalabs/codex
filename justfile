...
core-subagent-model-pinning-targeted:
    ...
    cargo nextest run -p codex-state -p codex-thread-store --no-fail-fast --no-tests=fail --lib -- extract::tests::thread_settings_replace_complete_configured_identity_and_clear_effort in_memory::tests::paginated_threads_allow_metadata_reads_and_reject_legacy_history_paths local::read_thread::tests::read_thread_keeps_complete_indexed_identity_during_rollout_overlay local::read_thread::tests::read_thread_keeps_complete_indexed_identity_for_malformed_rollout local::update_thread_metadata::tests::update_thread_metadata_applies_combined_explicit_patch thread_metadata_sync::tests::settings_events_replace_complete_configured_identity_and_preserve_clears types::tests::thread_metadata_patch_round_trips_optional_clears types::tests::legacy_reasoning_effort_null_remains_a_noop --exact
