...
app-server-computer-use-targeted:
    ...
    cargo test --locked -p codex-app-server --lib request_processors::thread_processor::thread_processor_tests::thread_processor_behavior_tests::browser_advertisement_does_not_treat_namespaced_name_as_top_level_duplicate -- --exact --test-threads=1
