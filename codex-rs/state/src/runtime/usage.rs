...
mod tests {
    ...
    #[derive(Debug, PartialEq, sqlx::FromRow)]
    struct CreditRateRow {
        rate_id: String,
        credits_per_1m_uncached_input: f64,
        credits_per_1m_cached_input: f64,
        credits_per_1m_output: f64,
...
"#,
    ...
    async fn credit_views_select_standard_fast_and_half_open_rates() -> Result<()> {
        ...
        let rate_rows: Vec<CreditRateRow> = sqlx::query_as(
            r#"
SELECT rate_id, credits_per_1m_uncached_input, credits_per_1m_cached_input,
       credits_per_1m_output, effective_from, effective_to
...
"#,
        ...
        assert_eq!(
            ...
            vec![
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-luna-fast-20260727".into(),
                    credits_per_1m_uncached_input: 62.5,
                    credits_per_1m_cached_input: 6.25,
                    credits_per_1m_output: 375.0,
                    effective_from: "2026-07-27T00:00:00Z".into(),
                    effective_to: Some("2026-07-30T00:00:00Z".into()),
                },
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-luna-fast-20260730".into(),
                    credits_per_1m_uncached_input: 12.5,
                    credits_per_1m_cached_input: 1.25,
                    credits_per_1m_output: 75.0,
                    effective_from: "2026-07-30T00:00:00Z".into(),
                    effective_to: None,
                },
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-luna-standard-20260402".into(),
                    credits_per_1m_uncached_input: 25.0,
                    credits_per_1m_cached_input: 2.5,
                    credits_per_1m_output: 150.0,
                    effective_from: "2026-04-02T00:00:00Z".into(),
                    effective_to: Some("2026-07-30T00:00:00Z".into()),
                },
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-luna-standard-20260730".into(),
                    credits_per_1m_uncached_input: 5.0,
                    credits_per_1m_cached_input: 0.5,
                    credits_per_1m_output: 30.0,
                    effective_from: "2026-07-30T00:00:00Z".into(),
                    effective_to: None,
                },
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-terra-fast-20260727".into(),
                    credits_per_1m_uncached_input: 156.25,
                    credits_per_1m_cached_input: 15.625,
                    credits_per_1m_output: 937.5,
                    effective_from: "2026-07-27T00:00:00Z".into(),
                    effective_to: Some("2026-07-30T00:00:00Z".into()),
                },
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-terra-fast-20260730".into(),
                    credits_per_1m_uncached_input: 125.0,
                    credits_per_1m_cached_input: 12.5,
                    credits_per_1m_output: 750.0,
                    effective_from: "2026-07-30T00:00:00Z".into(),
                    effective_to: None,
                },
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-terra-standard-20260402".into(),
                    credits_per_1m_uncached_input: 62.5,
                    credits_per_1m_cached_input: 6.25,
                    credits_per_1m_output: 375.0,
                    effective_from: "2026-04-02T00:00:00Z".into(),
                ...
                CreditRateRow {
                    rate_id: "openai-gpt-5.6-terra-standard-20260730".into(),
                    credits_per_1m_uncached_input: 50.0,
                    credits_per_1m_cached_input: 5.0,
                    credits_per_1m_output: 300.0,
                    effective_from: "2026-07-30T00:00:00Z".into(),
                    effective_to: None,
                },
            ]
...
"#,
        ...
        assert_eq!(
            ...
            vec![
                ...
                CreditEstimateRow {
                    provider_call_id: "fast-boundary".into(),
                    pricing_model: Some("gpt-5.6-luna".into()),
                    actual_service_tier: Some("priority".into()),
                    fast_mode_used: Some(true),
                    rate_id: Some("openai-gpt-5.6-luna-fast-20260730".into()),
                    uncached_input_credits: Some(12.5),
                    cached_input_credits: Some(1.25),
                    output_credits: Some(75.0),
                    rate_card_estimated_total_credits: Some(88.75),
                    estimated_total_credits: Some(88.75),
                    pricing_status: "priced_estimate".into(),
                    credit_source: Some("rate_card_estimate".into()),
                },
                CreditEstimateRow {
                ...
                CreditEstimateRow {
                    provider_call_id: "luna-boundary".into(),
                    pricing_model: Some("gpt-5.6-luna".into()),
                    actual_service_tier: Some("default".into()),
                    fast_mode_used: Some(false),
                    rate_id: Some("openai-gpt-5.6-luna-standard-20260730".into()),
                    uncached_input_credits: Some(5.0),
                    cached_input_credits: Some(0.5),
                    output_credits: Some(30.0),
                    rate_card_estimated_total_credits: Some(35.5),
                    estimated_total_credits: Some(35.5),
                    pricing_status: "priced_estimate".into(),
                    credit_source: Some("rate_card_estimate".into()),
                },
                CreditEstimateRow {
                    provider_call_id: "luna-post".into(),
                    pricing_model: Some("gpt-5.6-luna".into()),
                    actual_service_tier: Some("default".into()),
                    fast_mode_used: Some(false),
                    rate_id: Some("openai-gpt-5.6-luna-standard-20260730".into()),
                ...
                CreditEstimateRow {
                    provider_call_id: "sol-boundary".into(),
                    pricing_model: Some("gpt-5.6-sol".into()),
                    actual_service_tier: Some("default".into()),
                    fast_mode_used: Some(false),
                    rate_id: Some("openai-gpt-5.6-sol-standard-20260402".into()),
                ...
                CreditEstimateRow {
                    provider_call_id: "sol-fast".into(),
                    pricing_model: Some("gpt-5.6-sol".into()),
                    actual_service_tier: Some("priority".into()),
                    fast_mode_used: Some(true),
                    rate_id: Some("openai-gpt-5.6-sol-fast-20260727".into()),
                    uncached_input_credits: Some(312.5),
                    cached_input_credits: Some(31.25),
                    output_credits: Some(1875.0),
                    rate_card_estimated_total_credits: Some(2218.75),
                ...
                CreditEstimateRow {
                    provider_call_id: "sol-fast-boundary".into(),
                    pricing_model: Some("gpt-5.6-sol".into()),
                    actual_service_tier: Some("priority".into()),
                    fast_mode_used: Some(true),
                    rate_id: Some("openai-gpt-5.6-sol-fast-20260727".into()),
                ...
                CreditEstimateRow {
                    provider_call_id: "terra-boundary".into(),
                    pricing_model: Some("gpt-5.6-terra".into()),
                    actual_service_tier: Some("default".into()),
                    fast_mode_used: Some(false),
                    rate_id: Some("openai-gpt-5.6-terra-standard-20260730".into()),
                    uncached_input_credits: Some(50.0),
                    cached_input_credits: Some(5.0),
                    output_credits: Some(300.0),
                    rate_card_estimated_total_credits: Some(355.0),
                    estimated_total_credits: Some(355.0),
                    pricing_status: "priced_estimate".into(),
                    credit_source: Some("rate_card_estimate".into()),
                },
                CreditEstimateRow {
                    provider_call_id: "terra-fast".into(),
                    pricing_model: Some("gpt-5.6-terra".into()),
                    actual_service_tier: Some("priority".into()),
                    fast_mode_used: Some(true),
                    rate_id: Some("openai-gpt-5.6-terra-fast-20260727".into()),
                    uncached_input_credits: Some(156.25),
                    cached_input_credits: Some(15.625),
                    output_credits: Some(937.5),
                    rate_card_estimated_total_credits: Some(1109.375),
                    estimated_total_credits: Some(1109.375),
                    pricing_status: "priced_estimate".into(),
                    credit_source: Some("rate_card_estimate".into()),
                },
                CreditEstimateRow {
                    provider_call_id: "terra-fast-boundary".into(),
                    pricing_model: Some("gpt-5.6-terra".into()),
                    actual_service_tier: Some("priority".into()),
                    fast_mode_used: Some(true),
                    rate_id: Some("openai-gpt-5.6-terra-fast-20260730".into()),
                    uncached_input_credits: Some(125.0),
                    cached_input_credits: Some(12.5),
                    output_credits: Some(750.0),
                    rate_card_estimated_total_credits: Some(887.5),
                ...
                CreditEstimateRow {
                    provider_call_id: "terra-post".into(),
                    pricing_model: Some("gpt-5.6-terra".into()),
                    actual_service_tier: Some("default".into()),
                    fast_mode_used: Some(false),
                    rate_id: Some("openai-gpt-5.6-terra-standard-20260730".into()),
