...
pub enum SubAgentSource {
    ...
    /// A host-created diagnostic child. This is deliberately a distinct source
    /// variant rather than a task-name convention: model-controlled task names
    /// must never grant the diagnostic child's restricted admission profile.
    ContinuityDiagnostic {
        ...
        #[serde(default, alias = "agent_type")]
        agent_role: Option<String>,
        /// Immutable causal chain generated by the host before spawn.
        chain_id: String,
        /// Parent turn submission that authorized the probe.
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            SubAgentSource::ContinuityDiagnostic {
                ...
                depth,
                ..
            } => write!(f, "continuity_diagnostic_{parent_thread_id}_d{depth}"),
...
impl SubAgentSource {
    pub fn kind(&self) -> &str {
        match self {
            ...
            SubAgentSource::ContinuityDiagnostic { .. } => "continuity_diagnostic",
...
pub enum ReviewDecision {
    ...
    /// The approval flow timed out before the user or guardian completed a
    /// decision. Downstream may surface this distinctly from an explicit
    /// denial so agents can retry or explain the timeout accurately.
    TimedOut,
