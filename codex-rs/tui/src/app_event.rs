...
pub(crate) enum AppEvent {
    ...
    /// Close the active side conversation and return to its parent thread.
    ExitSideConversation,
    ...
    /// Update the active collaboration mode mask in the running app and widget.
