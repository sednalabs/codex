...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let installation_options_url = crate::version::installation_options_url();
        let release_notes_url = crate::version::latest_release_notes_url();
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        ...
        vec![
            ...
            Line::from(crate::version::latest_release_notes_url()),
        ]
    }
