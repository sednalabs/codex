...
fn stdio_mcp(command: &str) -> McpServerConfig {
    mcp_with_transport(McpServerTransportConfig::Stdio {
...
fn http_mcp(url: &str) -> McpServerConfig {
    mcp_with_transport(McpServerTransportConfig::StreamableHttp {
        url: url.to_string(),
...
fn mcp_with_transport(transport: McpServerTransportConfig) -> McpServerConfig {
    McpServerConfig {
        transport,
        enabled: true,
        required: false,
...
"#;
    ...
    assert_eq!(
        ...
        Tui {
            ...
            status_line: None,
            weekly_limit_pacing_style: WeeklyLimitPacingStyle::default(),
            terminal_title: None,
            theme: None,
...
fn test_precedence_fixture_with_o3_profile() -> std::io::Result<()> {
    ...
    assert_eq!(
        Config {
            ...
            tui_weekly_limit_pacing_style: WeeklyLimitPacingStyle::default(),
