...
"#,
    ...
    assert!(root_hint.contains(concurrency_guidance));
    ...
    assert!(subagent_hint.contains(concurrency_guidance));
}
...
"#,
    ...
    assert_eq!(
        err.to_string(),
        "features.multi_agent_v2.min_wait_timeout_ms must be at most 7200000"
    );
...
"#,
    ...
    assert_eq!(
        err.to_string(),
        "features.multi_agent_v2.max_wait_timeout_ms must be at most 7200000"
    );
