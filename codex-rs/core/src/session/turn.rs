...
async fn run_sampling_request(
    ...
    let continuation_health_check_turn = continuation_health_check_enabled
        ...
        && turn_context
            .extension_data
            .get::<GoalContinuationHealthCheckTurn>()
            .is_some();
    let mut retries = 0;
...
pub(crate) async fn built_tools(
    ...
    let tool_router = Arc::new(ToolRouter::from_context(
        ...
        ToolRouterParams {
            ...
            extension_tool_executors: if sess.is_continuity_health_check() {
                Vec::new()
            } else {
