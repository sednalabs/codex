...
/// Controls whether processes launched inside the Linux sandbox may outlive
/// the command that created the sandbox. Most callers retain the historical
/// terminate-with-parent behaviour; only shell-tool execution opts into
/// detached-child custody.
