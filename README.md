...
See [Native computer-use adapter tooling](./docs/native-computer-use.md), the [computer-use cleanroom contracts](./docs/native-computer-use-contracts.md), and the [tool surface matrix](./docs/downstream-tool-surface-matrix.md).
...
| Provider implementation boundaries         | [Computer-use cleanroom contracts](./docs/native-computer-use-contracts.md) |
