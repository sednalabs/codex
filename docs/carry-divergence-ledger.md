...
- Storage distinguishes legacy-missing, valid, explicitly cleared, and malformed configured/request identity authority without letting reconciliation erase unobserved state.
