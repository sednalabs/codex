...
- downstream branch `main` code tree: `3281fd19b79d55cb774840f8067cfb7a6f18d18e`
...
- downstream branch vs `upstream/main`: `1634` downstream ahead, `0` upstream ahead
- Mirror vs `upstream/main`: `0` ahead, `0` behind (`exact`)
- Downstream-only commits at audit time: `1434` unique, `0` patch-equivalent
