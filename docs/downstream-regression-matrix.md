...
| Upgradeable legacy models stay visible across the interactive picker and spawned-agent model guidance without widening to the whole UI or app-server family | `codex.tui-agent-picker-model-surface-targeted` | `model_picker_shows_upgradeable_legacy_models_from_cache`; `spawn_agent_tool_v2_requires_task_name_and_lists_visible_models`; `spawn_agent_tool_v2_lists_upgradeable_legacy_models`; `suite::spawn_agent_description::spawn_agent_description_lists_visible_models_and_reasoning_efforts` |
