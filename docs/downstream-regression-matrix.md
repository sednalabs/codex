...
| TUI contributor slots for recurring downstream status, history, bottom-pane, update-prompt, and computer-use display surfaces | `codex.tui-agent-usage-totals-targeted`; `codex.tui-native-computer-use-targeted` | `contributor_slots::*`; `status_indicator_widget::* snapshots`; `update_prompt_snapshot`; `bottom_pane::* snapshots`; `computer_use_call_labels_native_surfaces` |
