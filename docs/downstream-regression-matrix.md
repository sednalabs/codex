...
| Phase-2 attested output baselines and downstream state migration slot allocation | `codex.core-attestation-targeted`; `core-ledger-smoke` | `phase2_attestation::*`; `memories_startup_phase2_*`; SQLx migrator startup in `codex-state` runtime tests |
