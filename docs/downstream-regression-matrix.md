...
- `codex.state-migration-compat-targeted`
...
| Phase-2 attestation contract and upstream-compatible state migration lineage | `codex.core-attestation-targeted`; `codex.state-migration-compat-targeted`; `core-ledger-smoke` | `consolidation_artifacts_ready_rejects_*`; `global_phase2_attestation_requirement_is_root_scoped`; upstream-0.129 and shifted-Sedna SQLx migrator startup tests in `codex-state` |
