...
- See [`native-computer-use-contracts.md`](native-computer-use-contracts.md) for the sanitized desktop, browser-shell, Chrome-extension, and bundled-plugin cleanroom contracts.
