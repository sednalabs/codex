...
- Successful MultiAgentV2 child completion places a bounded runtime-authored
  ...
  sampling response. Errored and interrupted outcomes never attach a receipt;
  encoded receipt fields and payload share a hard sub-1,000-token item budget.
