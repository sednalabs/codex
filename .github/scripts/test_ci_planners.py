...
class RouteSelectionTests(unittest.TestCase):
    ...
    def test_session_tui_resource_stability_lane_pins_the_full_regression_slice(
        ...
        for test_name in (
            ...
            "in_process_facade_",
            "tests::in_process_pending_required_event_still_allows_request_control",
            "tests::in_process_pending_required_event_still_allows_resolve_control",
            "tests::in_process_pending_required_event_still_allows_reject_control",
